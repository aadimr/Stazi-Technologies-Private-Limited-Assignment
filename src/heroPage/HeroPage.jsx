...
function HeroPage() {
    return (
        <div className="m-6 flex flex-wrap gap-[1rem]">
            {
                carData.map((ele, index) => (
                    <div key={index} className="p-[.7rem] rounded-[1rem] bg-slate-100 shadow-lg">
                        ...
                        <hr />
                         <div className="m-[1rem] flex justify-between">
                            ...
                            <span className="bg-[#E0F0FF] w-[2.3rem] h-[2.3rem] rounded-[.7rem] flex justify-center items-center"><AiOutlineHeart className="text-[1.5rem] text-[#6CB4EE]"/></span>
                            <Button name={"Rent now"} className="border-2 w-[6rem] h-[2.5rem] text-white rounded-[.7rem] bg-[#6CB4EE]"/>
                            </div>
                        </div>
                    </div>
                ))
